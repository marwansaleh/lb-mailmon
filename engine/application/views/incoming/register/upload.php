        ...
        <div class="widget">
            ...
            <div class="widget-content clearfix">
                <form id="myUpload" method="POST" class="form-validation" enctype="multipart/form-data">
                    <input type="hidden" id="mail-id" name="id" value="<?php echo $incoming->id; ?>" />
                    <input type="hidden" name="type" value="incoming" />
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Nomor Surat</label>
                                <input type="text" readonly="true" class="form-control" value="<?php echo $incoming->nomor_surat; ?>">
                            </div>
                        </div>
                        <div class="col-lg-9">
                            <div class="form-group">
                                <label>Perihal</label>
                                <input type="text" readonly="true" class="form-control" value="<?php echo $incoming->perihal; ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
...
<script type="text/javascript">
    var Mail = {
        ...
        loadData: function(){
            ...
            $.ajax({
                url: '<?php echo get_action_url('service/attachment/bymail'); ?>/'+_this.mailId+'/incoming',
                type: 'GET',
                dataType: 'json'
            }).then(function(data){
