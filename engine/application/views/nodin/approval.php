...
<form id="MyForm" method="POST" class="form-validation">
    ...
    <input type="hidden" name="status" value="<?php echo STATUS_OUT_APPROVAL; ?>" />
    <div class="widget">
    ...
    <div class="form-group form-group-lg">
        <button type="submit" id="btn-submit" class="btn btn-primary btn-large" data-loading-text="Wait..."><i class="fa fa-save"></i> Kirim Permohonan</button>
            ...
            $.ajax({
                ...
                if (data.item_count > 0){
                    for (var i in data.items){
                        ...
                        s+= '<td class="text-center">'+(disposisi.diterima ? '<i class="fa fa-check"></i>':'<i class="fa fa-question"></i>')+'</td>';
                        s+= '</tr>';
