        ...
        <div class="widget">
            ...
            <div class="widget-content clearfix">
                <form id="myUpload" method="POST" class="form-validation" enctype="multipart/form-data">
                    <input type="hidden" id="mail-id" name="id" value="<?php echo $outgoing->id; ?>" />
                    <input type="hidden" id="mail-tipe" name="type" value="<?php echo MAIL_OUTGOING ?>" />
                    <div class="row">
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label>Nomor Surat</label>
                                <input type="text" readonly="true" class="form-control" value="<?php echo $outgoing->nomor_surat; ?>">
                            </div>
                        </div>
                        <div class="col-lg-9">
                            <div class="form-group">
                                <label>Perihal</label>
                                <input type="text" readonly="true" class="form-control" value="<?php echo $outgoing->perihal; ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="row">
